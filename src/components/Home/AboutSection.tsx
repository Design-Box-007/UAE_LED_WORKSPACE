    ...
    return (
        <section className="relative w-full bg-gray-50 px-20 py-20">
            <div className="mx-auto max-w-[1320px]">
                ...
                {/* Content Section */}
                <div className="flex flex-row justify-between items-start gap-[21px] w-[100%] h-[636px]">
                    {/* Left Column: Stats Cards */}
                    <div className="space-y-4 flex-none w-88 h-full flex flex-col justify-center">
                        {/* Card 1 */}
                        <div className="bg-white p-6 rounded-2xl shadow-sm h-36 flex flex-col">
                            <div className="w-10 h-10 flex items-center justify-center mb-6">
                                <svg className="w-8 h-8 text-[#0f123f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="mt-auto">
                                <p className="font-semibold text-gray-900 text-m leading-tight">1500+ successful installations worldwide</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm h-36 flex flex-col">
                            ...
                            <div className="mt-auto">
                                <p className="font-semibold text-gray-900 text-m leading-tight">Serving clients across 15+ countries</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm h-36 flex flex-col">
                            ...
                            <div className="mt-auto">
                                <p className="font-semibold text-gray-900 text-m leading-tight">Trusted by brands in events, retail, real estate, and government sectors</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm h-36 flex flex-col">
                            ...
                            <div className="mt-auto">
                                <p className="font-semibold text-gray-900 text-m leading-tight">Customizable LED solutions for every use case</p>
                            </div>
                        </div>
                    </div>

                    {/* Right Column: Large Image with CTA Button */}
                    <div className="relative flex-grow h-full rounded-2xl overflow-hidden shadow-lg">
                        <Image
                        ...
                        <div className="absolute bottom-8 right-8">
                            <div className="bg-white p-4 rounded-2xl shadow-sm">
                                <button className="inline-flex items-center gap-2 text-[#0f123f] font-medium hover:gap-3 transition-all duration-300">
                                    Learn More About Us
