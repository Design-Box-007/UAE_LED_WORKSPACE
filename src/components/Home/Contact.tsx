      ...
      <div className="mx-auto">
        ...
        {/* <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-10 items-start mb-12 md:mb-16 text-center lg:text-left">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-center sm:flex-row gap-3 md:gap-4 items-center lg:items-start">
              <ContactButton 
                icon={<WhatsAppIcon />}
                label="Connect Us Through WhatsApp"
                smallLabel="WhatsApp"
              />
              
              <ContactButton 
                icon={<EmailIcon />}
                label="Connect Us Through Email"
                smallLabel="Email"
              />
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-12 shadow-sm">
          ...
          <form className="space-y-4 md:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <FormInput type="tel" placeholder="Mobile No" />
