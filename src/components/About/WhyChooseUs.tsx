  ...
  <div className="w-full rounded-[30px] drop-shadow-lg bg-gray-50 py-8 md:py-10 px-6 md:px-10">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
      {cardDetails.map((card, idx) => (
        <div
          key={idx}
          className="bg-[linear-gradient(180deg,_#001A49_0%,_#4845D2_100%)] rounded-xl p-6 md:p-10 lg:p-13 flex flex-col justify-between gap-6 md:gap-8 lg:gap-11"
        >
          <h3 className="text-2xl md:text-4xl lg:text-6xl text-white mb-4 md:mb-6 leading-snug lg:leading-[80px]">
            {card.title}
          </h3>
